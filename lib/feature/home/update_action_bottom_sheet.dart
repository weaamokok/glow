...
class UpdateActionBottomSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    final promptController = // In your widget
        ref.watch(PromptCreatorDeps.promptProvider.notifier);
                  ...
                  return TextButton(
                    onPressed: () async {
                      ...
                      if (form.valid) {
                        ...
                        final updatePrompt =
                            await promptController.updateActionPrompt(
                                action: newAction, isEdit: action != null);
                        updatePrompt.maybeMap(orElse: () {
                          ...
                          children: weekDays.map(
                            (day) {
                              return InkWell(
                                onTap: () {
                                  final updated =
                                      List<String>.from(frequencyList);
